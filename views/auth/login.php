...
<div class="min-h-screen flex items-center justify-center bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-gray-800 p-8 rounded-lg shadow-lg">
        <h1 class="text-center text-3xl font-extrabold text-white">Login</h1>
        ...
        <form action="/app1/public/auth/login_process" method="POST" class="mt-8 space-y-6">
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" autocomplete="current-password" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-600 placeholder-gray-400 text-white bg-gray-700 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm" placeholder="Password">
                </div>
            </div>
        ...
        <p class="text-center text-gray-300 mt-2">
            Don't have an account? <a href="/app1/public/auth/register" class="font-medium text-blue-400 hover:text-blue-300">Register here</a>
        </p>
    </div>
</div>
