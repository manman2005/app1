...
<div class="min-h-screen flex items-center justify-center bg-accent-light py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
        <h1 class="text-center text-3xl font-extrabold text-text-main">Login</h1>
        ...
        <p class="text-center text-text-main mt-2">
            Don't have an account? <a href="/app1/public/auth/register" class="font-medium text-accent hover:text-opacity-80">Register here</a>
        </p>
    </div>
</div>
