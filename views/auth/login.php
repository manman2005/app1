    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-5xl">
        <div class="bg-white shadow-2xl rounded-3xl overflow-hidden md:flex">
            ...
            <div class="w-full md:w-1/2 p-8 sm:p-12">
                <div class="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <p class="mt-2 text-center text-sm text-gray-600">
                        ยังไม่มีบัญชี? <a href="<?= BASE_PATH ?>/auth/register" class="font-medium text-accent hover:text-highlight">
                            สมัครสมาชิกที่นี่
                        </a>
                    </p>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <form action="<?= BASE_PATH ?>/auth/login_process" method="POST" class="space-y-6">
                        <div>
            ...
            <div class="hidden md:block md:w-1/2">
                <img class="object-cover h-full w-full" src="<?= BASE_PATH ?>/img/man2.jpg" alt="Login page background image">
            </div>
