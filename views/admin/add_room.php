...
<div class="container mx-auto px-6 py-8">
    ...
    <form action="/app1/public/admin/addRoom" method="POST" enctype="multipart/form-data" class="">
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-200 leading-tight focus:outline-none focus:shadow-outline bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600" id="image" type="file" name="image[]" accept="image/*" multiple>
        </div>
