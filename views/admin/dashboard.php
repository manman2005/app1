...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center">
            ...
            <p class="text-4xl font-bold text-accent mt-2">123</p>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center">
            <h3 class="text-lg font-semibold text-text-main">Total Rooms</h3>
            <p class="text-4xl font-bold text-accent mt-2">45</p>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center">
            <h3 class="text-lg font-semibold text-text-main">New Bookings</h3>
            <p class="text-4xl font-bold text-accent mt-2">7</p>
        </div>
    </div>
...
<!-- Bookings Table -->
<div id="booking-management" class="bg-accent-light p-6 rounded-lg shadow-md mt-8">
...
<div id="room-management" class="bg-accent-light p-6 rounded-lg shadow-md mt-8">
    <div class="flex justify-between items-center mb-4">
